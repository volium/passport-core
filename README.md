...
The sibling app consumes an explicit `vendor/passport-core-0.4.2.tgz` archive, checked into the app repository so CI does not need this checkout or an unpublished registry package.
